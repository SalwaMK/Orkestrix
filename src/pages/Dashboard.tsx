...
import { formatCurrency, normalizeToMonthly, isRenewingSoon } from '@/lib/utils'
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
        <span
          style={{
            ...
            background:     warn ? 'rgba(251,191,36,0.12)' : 'rgba(15,118,110,0.16)',
            border:         warn ? '1px solid rgba(251,191,36,0.25)' : '1px solid rgba(34,211,238,0.16)',
...
export function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    const renewingSoon = tools.filter((t) => isRenewingSoon(t.renewalDate)).length
  ...
  if (error) {
    return (
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '0.85rem', color: 'rgba(219,243,244,0.45)' }}>
          {error}
        </p>
        <p style={{ margin: 0, fontSize: '0.8rem', color: 'rgba(219,243,244,0.35)' }}>
    ...
    >
      ...
      {isEmpty && (
        ...
        >
          ...
          <div>
            <p style={{ margin: 0, fontWeight: 700, fontSize: '1.1rem', color: '#f3fbfb' }}>
              No tools yet
            </p>
            <p style={{ margin: '6px 0 0', color: 'rgba(219,243,244,0.50)', fontSize: '0.9rem' }}>
